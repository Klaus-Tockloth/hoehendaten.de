...
(function() { // Wrap in an IIFE for basic encapsulation, common for "simple js" files

// === Core Utilities (from bundler output) ===
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);

// === EventEmitter (originally from 'events' module) ===
// Note: getDefaultExportFromCjs and events object are removed/simplified
// as the full EventEmitter implementation is inline.

var R = typeof Reflect === "object" ? Reflect : null;
var ReflectApply = R && typeof R.apply === "function" ? Reflect.apply : function ReflectApply2(target, receiver, args) {
...
// Original: events.exports = EventEmitter;
// Original: events.exports.once = once2; // This 'once2' function is defined later.
// We'll expose EventEmitter globally as part of the ColorPicker object at the end.

EventEmitter.EventEmitter = EventEmitter; // Self-reference, common in Node.js modules
...
function once2(emitter, name) { // Renamed from original for clarity, but the original intent was for `events.exports.once`
...
// === Popper.js (all inline) ===
// No changes here except the initial 'const EventEmitter$1' alias is removed,
// as the EventEmitter class is now directly available in this scope.
var top = "top";
var bottom = "bottom";
var right = "right";
var left = "left";
...
// === Slider Class ===
class Slider extends EventEmitter { // Used EventEmitter directly here
  constructor($element) {
    super();
...
// === ColorPicker Configuration and DOM ===
const defaultConfig = {
  headless: false,
  toggleStyle: "button",
  container: null,
...
let currentlyOpen; // This will remain a global-like variable within the IIFE.

// === ColorPicker Class ===
class ColorPicker extends EventEmitter { // Used EventEmitter directly here
  /**
...
__publicField(ColorPicker, "Color", Color); // Expose Color class via ColorPicker

// Expose the main ColorPicker class to the global scope (window)
